...
def create_pipe():
    ...
    top_pipe = pipe_surface.get_rect(midbottom = (500,random_pipe_pos - 130))
...
def bird_animation():
    ...
    new_bird_rect = new_bird.get_rect(center = (34,bird_rect.centery))
...
bird_rect = bird_surface.get_rect(center = (34,24))

BIRDLAP = pygame.USEREVENT + 1
pygame.time.set_timer(BIRDLAP,100)
